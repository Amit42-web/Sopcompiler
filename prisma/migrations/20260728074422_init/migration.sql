...
-- CreateEnum
CREATE TYPE "FileStatus" AS ENUM ('uploaded', 'parsing', 'parsed', 'processing', 'processed', 'error');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('sop_uploaded', 'metadata_extracted', 'sections_detected', 'scenarios_extracted', 'knowledge_base_built', 'rules_generated', 'validation_completed', 'json_exported', 'sop_reprocessed', 'sop_renamed', 'sop_duplicated', 'sop_deleted');
